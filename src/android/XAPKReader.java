...
public class XAPKReader extends CordovaPlugin {
    ...
    public static CallbackContext lastCallbackContext = null;
    ...
    public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) throws JSONException {
        ...
        if(action.equals("startDownload")){
            ...
            final int version = args.getInt(1);
            final int filesize = args.getInt(2);
            final String progressTitle = args.getString(3);
            final String progressMessage = args.getString(4);

            XAPKReader.key = key;

            Log.d(LOG_TAG, "Version :"+version+" FileSize : " + filesize);
            Log.d(LOG_TAG, " Title : " + progressTitle );
            Log.d(LOG_TAG, " Message : " + progressMessage );
            Log.d(LOG_TAG, " Key : " + key.substring(0,10) );
            ...
            cordova.getThreadPool().execute(new Runnable() {
                public void run() {
                    ...
                    bundle.putInt("mainVersion", 1); //Always use main version
                    bundle.putInt("patchVersion", version);
                    bundle.putLong("fileSize", filesize);
                    bundle.putString("progressTitle",progressTitle);
                    bundle.putString("progressMessage",progressMessage);
                    ...
                    cordova.getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Log.d(LOG_TAG, "Start downloader activity");
