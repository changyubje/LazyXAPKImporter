...
module.exports = {
    ...
    startDownload: function(key, version, filesize, progressTitle, progressMessage, successCallback, failCallback) {

        console.log("Check and start obb download");

        cordova.exec(successCallback, failCallback, "XAPKReader", "startDownload", [key, version, filesize, progressTitle, progressMessage]);        
